...
const PRODUCTS = [
  ...
  { id: 'p3',  name: 'ERP Suite',              cat: 'enterprise',     Icon: Building2,      desc: 'Full-stack enterprise resource planning — finance, procurement, supply chain, and operations.',          tags: ['Finance', 'Supply Chain'],           top: '#f59e0b' },
  { id: 'p4',  name: 'Service Ticketing',      cat: 'enterprise',     Icon: HeadphonesIcon, desc: 'ITIL-aligned service desk with SLA tracking, automation rules, and self-service portal.',               tags: ['ITIL', 'Automation'],                top: '#16a34a' },
  ...
  { id: 'p9',  name: 'VMS',                    cat: 'security',       Icon: Video,          desc: 'Centralised video management with multi-camera control, intelligent playback, and archiving.',           tags: ['HD Video', 'AI Search'],             top: '#2563eb' },
  { id: 'p10', name: 'Video Analytics',        cat: 'security',       Icon: ScanSearch,     desc: 'Deep learning analytics for crowd counting, intrusion detection, and behavioural analysis.',             tags: ['Deep Learning', 'Edge AI'],          top: '#dc2626' },
  { id: 'p11', name: 'Face Recognition (FRS)', cat: 'security',       Icon: ScanFace,       desc: '99.9% accurate biometric face recognition for access control, attendance, and identity.',                tags: ['Biometric', 'AI'],                   top: '#7c3aed' },
  { id: 'p12', name: 'Visitor Management',     cat: 'security',       Icon: BadgeCheck,     desc: 'Digital visitor registration, badge printing, host alerts, and compliance audit trails.',                tags: ['Digital', 'Compliance'],             top: '#ea580c' },
  { id: 'p13', name: 'MDM',                    cat: 'infrastructure', Icon: Smartphone,     desc: 'Mobile Device Management — policy enforcement, remote wipe, app distribution, and compliance.',         tags: ['iOS', 'Android', 'Windows'],         top: '#16a34a' },
  { id: 'p14', name: 'NMS',                    cat: 'infrastructure', Icon: Network,        desc: 'Network Monitoring with real-time topology, SNMP polling, alerting, and performance baselines.',         tags: ['SNMP', 'NETFLOW'],                   top: '#f59e0b' },
  { id: 'p15', name: 'Firewall & UTM',         cat: 'infrastructure', Icon: ShieldCheck,    desc: 'Next-gen firewall with IPS, web filtering, application control, and VPN management.',                   tags: ['NGFW', 'UTM', 'IPS'],                top: '#dc2626' },
  { id: 'p16', name: 'SD-WAN',                cat: 'infrastructure', Icon: GitMerge,       desc: 'Software-defined WAN with zero-touch provisioning, multi-cloud routing, and QoS policies.',             tags: ['ZTP', 'Multi-Cloud'],                top: '#0891b2' },
]
