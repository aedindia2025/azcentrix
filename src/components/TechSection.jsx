import { Cloud, Bot, Lock, Zap, Plug, ClipboardCheck } from 'lucide-react'
import './TechSection.css'

const TECHS = [
  { num: '01', Icon: Cloud,           title: 'Cloud-Native Core',       desc: 'Kubernetes-orchestrated microservices with multi-region deployment on AWS, Azure, and GCP. Scales horizontally without configuration.' },
        ...
        <div className="tech-grid reveal">
          {TECHS.map(t => (
            <div key={t.num} className="tech-cell">
              ...
              <div className="tech-icon"><t.Icon size={26} strokeWidth={1.6} /></div>
